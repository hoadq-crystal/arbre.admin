...
function mergeFields(mergedTypeInfo, object, sourceSubschema, targetSubschemas, context, info) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    delegationMaps = buildDelegationPlanFromInfo(info, mergedTypeInfo, sourceSubschema, targetSubschemas);
                    _b.label = 1;
                case 1:
                ...
                case 7:
                    try {
                        if (delegationMaps_1_1 && !delegationMaps_1_1.done && (_a = delegationMaps_1.return)) _a.call(delegationMaps_1);
                    }
                    finally { if (e_1) throw e_1.error; }
                    return [7 /*endfinally*/];
...
function executeDelegationStage(mergedTypeInfo, delegationMap, object, context, info) {
    var _a, _b;
    return tslib.__awaiter(this, void 0, void 0, function () {
        var combinedErrors, path, newFieldSubschemaMap, type, results, combinedResult;
        var _this = this;
        return tslib.__generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    combinedErrors = (_a = object[UNPATHED_ERRORS_SYMBOL]) !== null && _a !== void 0 ? _a : [];
                    path = graphql.responsePathAsArray(info.path);
                    newFieldSubschemaMap = (_b = object[FIELD_SUBSCHEMA_MAP_SYMBOL]) !== null && _b !== void 0 ? _b : Object.create(null);
                    ...
                    return [4 /*yield*/, Promise.all(tslib.__spreadArray([], tslib.__read(delegationMap.entries())).map(function (_a) {
                            ...
                            return tslib.__awaiter(_this, void 0, void 0, function () {
                                var resolver, source, error_1, fieldNodes, nullResult, responseKey, combinedPath, objectSubschema, fieldSubschemaMap, responseKey;
                                var _c;
                                    ...
                                    switch (_d.label) {
                                        ...
                                        case 4:
                                            if (source instanceof Error || source === null) {
                                                fieldNodes = execute_js.collectFields({
                                                    schema: info.schema,
                                                    variableValues: {},
                                                    fragments: {},
                                                }, type, selectionSet, Object.create(null), Object.create(null));
                                                nullResult = {};
                                                for (responseKey in fieldNodes) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, combinedResult];
            }
        });
    });
}
var buildDelegationPlanFromInfo = memoize4(function buildDelegationPlanFromInfo(info, mergedTypeInfo, sourceSubschema, targetSubschemas) {
    var _a;
    var schema = info.schema, fragments = info.fragments, variableValues = info.variableValues, fieldNodes = info.fieldNodes;
    return mergedTypeInfo.delegationPlanBuilder(schema, sourceSubschema, fieldNodes, fragments, variableValues, (_a = schema.extensions) === null || _a === void 0 ? void 0 : _a['stitchingInfo'], mergedTypeInfo, targetSubschemas);
});
...
function resolveExternalObject(type, object, unpathedErrors, subschema, context, info, skipTypeMerging) {
    ...
    return mergeFields(mergedTypeInfo, object, subschema, targetSubschemas, context, info);
}
