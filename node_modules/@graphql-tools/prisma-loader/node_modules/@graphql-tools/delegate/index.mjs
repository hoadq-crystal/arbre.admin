...
async function mergeFields(mergedTypeInfo, object, sourceSubschema, targetSubschemas, context, info) {
...
async function executeDelegationStage(mergedTypeInfo, delegationMap, object, context, info) {
    var _a, _b;
    const combinedErrors = (_a = object[UNPATHED_ERRORS_SYMBOL]) !== null && _a !== void 0 ? _a : [];
    const path = responsePathAsArray(info.path);
    const newFieldSubschemaMap = (_b = object[FIELD_SUBSCHEMA_MAP_SYMBOL]) !== null && _b !== void 0 ? _b : Object.create(null);
...
const buildDelegationPlanFromInfo = memoize4(function buildDelegationPlanFromInfo(info, mergedTypeInfo, sourceSubschema, targetSubschemas) {
    var _a;
